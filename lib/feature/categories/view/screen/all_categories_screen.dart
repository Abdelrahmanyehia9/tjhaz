...
import '../widget/side_bar_categories.dart';
                              ...
                              return InkWell(
                                  onTap: () {
                                    context.push(AppRouter.entertainmentScreen,
                                        extra: {
                                          "parent": AppConstants.categories[
                                              context
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image:category.image != null ? DecorationImage(image: CachedNetworkImageProvider(category.image! ) ,fit: BoxFit.cover) : null
            ),
